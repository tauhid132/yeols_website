        ...
        <div class="container">
            <div class="row row-gap-40 list-news">
              ...
              <div class="col-lg-4 col-sm-6 item">
                <div class="blog-item blog-item-filter hover-box-shadow case-studies-item-main"><a class="main-item">
                    ...
                    <div class="infor mt-28">
                        ...
                        <div class="block-button mt-20"><a class="button bg-blue button-blue-hover text-white border-none" href="{{ route('view.portfolio.single', $portfolio->id) }}">View Details</a></div>
