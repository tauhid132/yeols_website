    ...
    <div class="row">
        <div class="col-12 mb-4 mb-sm-5">
            <div class="d-sm-flex justify-content-between align-items-center">
                <h1 class="h3 mb-3 mb-sm-0">Create New Project</h1>
            </div>
        </div>
    </div>
    <form action="{{ route('viewCreateNewProject') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="file" class="form-control" name="project_cover_image" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="ckeditor form-control" name="project_description" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
