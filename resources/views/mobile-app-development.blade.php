@extends('master')
@section('page-title', "Mobile App Development")
@section('main-body')
<div id="content">
    ...
    <div class="section-about style-seven-second style-seven-third pt-80 pb-80">
        <div class="container"> 
          <div class="row row-gap-40 flex-between">
            <div class="col-12 col-lg-5 col-md-8 col-sm-10"><img class="w-100" src="{{ asset('images/services/app-development.jpg') }}" alt="img"/></div>
            <div class="col-12 col-lg-7 pl-65 pl-col-lg-0">
              ...
              <div class="benefit-item flex-item-center mt-28"> <i class="fa fa-check fs-42 display-block"></i>
                <div class="title pl-16">
                  ...
                  <p>We design mobile apps ensuring User Experience and Responsiveness</p>
                </div>
              </div>
              <div class="benefit-item flex-item-center mt-28"> <i class="ph-fill ph-chart-bar fs-42 display-block"></i>
                <div class="title pl-16">
                  ...
                  <p>We use Javascript frameworks like React Native, Flutter to build Robust SPA Applications.</p>
                </div>
              </div>
              <div class="benefit-item flex-item-center mt-28"> <i class="ph-fill ph-chart-line-down fs-42 display-block"></i>
                <div class="title pl-16">
