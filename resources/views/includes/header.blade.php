    ...
    <div class="header-menu style-one style-two">
      ...
      <img src="{{ asset('logo.png') }}" style="height: 40px">
        ...
        <div class="right-block flex-item-center">
          <div class="call-block flex-item-center"><i class="fa fa-phone"></i><span>09614 23 23 23</span></div><a class="button hover-button bg-blue text-white border-none text-button-small" href="contact-us.html"><i class="fa fa-calendar"></i> <span>Schedule a Meeting</span></a>
