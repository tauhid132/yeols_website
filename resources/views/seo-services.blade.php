@extends('master')
@section('page-title', "SEO Services")
@section('main-body')
<div id="content">
    ...
    <div class="section-about style-seven-second style-seven-third pt-80 pb-80">
        <div class="container"> 
          <div class="row row-gap-40 flex-between">
            <div class="col-12 col-lg-5 col-md-8 col-sm-10"><img class="w-100" src="{{ asset('images/services/seo-services.jpg') }}" alt="img"/></div>
            <div class="col-12 col-lg-7 pl-65 pl-col-lg-0">
              ...
              <div class="heading3 mt-20">Search Engine Optimization (SEO)</div>
